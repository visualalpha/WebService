...
class Dataset
{
    ...
    async save_dataset_data_into_our_csvs_files( filepath1, data1, header1, filepath2, data2, header2, filepath3, data3, header3 )
    {
    ...
    async _dataset_generator_impl( days, winsize, end_dateiso, whitelist = null )
    {
        ...
        this.save_dataset_data_into_our_csvs_files( csv_filepath, data_obj["csv_data"], data_obj["csv_header"], label_filepath, 
